...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"Adisa"), InlineKeyboardButton(text="Hᴏᴍᴇ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="▷", callback_data=f"TaitanXaditi")]
...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data=f"settings_back_helper_fixed"), InlineKeyboardButton(text="Hᴏᴍᴇ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="▷", callback_data=f"settings_back_helper")]
