from TaitanX import app as bot
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="⦿ Whisper ⦿",
            description=f"@TaitanMusicBot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**❍ Usage:**\n\n@Alone_Taitan_bot (Target Username or ID) (Your Message).\n\n**Example:**\n@TaitanMusicBot @username I Wanna Phuck You"),
            thumb_url="https://te.legra.ph/file/70872d57cab08aa096a04.jpg",
            reply_markup=switch_btn
        )
    ]
