...
from TaitanX.misc import _boot_
from TaitanX.plugins.sudo.sudoers import sudoers_list
...
from TaitanX.utils.decorators.language import LanguageStart
from TaitanX.utils.formatters import get_readable_time
from TaitanX.utils.inline import first_page, private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CcmOuMwABAk-0Zf9lYzqiF5pgDhT1yJJh-uDsoUgAAhUGAAKtmOFXPUDgFyf2eRkeBA")
